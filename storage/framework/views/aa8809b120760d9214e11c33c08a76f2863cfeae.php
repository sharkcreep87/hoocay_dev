...
<?php $__env->startSection('title'); ?>
    <title><?php echo e($static_data['strings']['resend_activation_mail']); ?> - <?php echo e($static_data['site_settings']['site_name']); ?></title>
    <meta charset="UTF-8">
...
<?php $__env->startSection('content'); ?>
    <div class="row  marginalized justify-content-center">
        <div class="col-sm-12"><h1 class="section-title-dark"><?php echo e($static_data['strings']['resend_activation_mail']); ?></h1></div>
        <div class="col-sm-12 col-md-8 input-style">
            <?php if(Session::has('notFoundEmail')): ?>
                <p class="section-subtitle-light text-centered red-color"><strong><?php echo e($static_data['strings']['wrong_email']); ?></strong></p>
            <?php endif; ?>
            <?php echo Form::open(['method' => 'post', 'url' => route('resend_activation')]); ?>
