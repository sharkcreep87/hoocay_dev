...
<div class="col s12 mtop10">
    <?php echo Form::open(['method' => 'put', 'url' => route('admin_my_account_update', Auth::user()->id), 'files' => 'true']); ?>
    ...
    <div class="col l4 m4 s6">
        <div class="form-group  <?php echo e($errors->has('first_name') ? 'has-error' : ''); ?>">
            <?php echo Form::text('first_name', $user->admin->first_name, ['id' => 'first_name', 'class' => 'form-control', 'placeholder' => get_string('first_name')]); ?>
    ...
    <div class="col l4 m4 s6">
        <div class="form-group <?php echo e($errors->has('last_name') ? 'has-error' : ''); ?>">
            <?php echo Form::text('last_name', $user->admin->last_name, ['id' => 'last_name', 'class' => 'form-control', 'placeholder' => get_string('last_name')]); ?>
    ...
    <div class="col l4 m4 s6">
        <div class="form-group <?php echo e($errors->has('last_name') ? 'has-error' : ''); ?>">
            <?php echo Form::text('company', $user->admin->company, ['id' => 'company', 'class' => 'form-control', 'placeholder' => get_string('company')]); ?>
    ...
    <div class="col l4 m4 s6">
        <div class="form-group <?php echo e($errors->has('address') ? 'has-error' : ''); ?>">
            <?php echo Form::text('address', $user->admin->address, ['id' => 'address', 'class' => 'form-control', 'placeholder' => get_string('address')]); ?>
    ...
    <div class="col l4 m4 s6">
        <div class="form-group <?php echo e($errors->has('city') ? 'has-error' : ''); ?>">
            <?php echo Form::text('city', $user->admin->city, ['id' => 'city', 'class' => 'form-control', 'placeholder' => get_string('city')]); ?>
    ...
    <div class="col l4 m4 s6">
        <div class="form-group <?php echo e($errors->has('state') ? 'has-error' : ''); ?>">
            <?php echo Form::text('state', $user->admin->state, ['id' => 'state', 'class' => 'form-control', 'placeholder' => get_string('state')]); ?>
    ...
    <div class="col l4 m4 s6">
        <div class="form-group <?php echo e($errors->has('country') ? 'has-error' : ''); ?>"">
            <?php echo Form::text('country', $user->admin->country, ['id' => 'country', 'class' => 'form-control', 'placeholder' => get_string('country')]); ?>
    ...
    <div class="col l4 m4 s6">
        <div class="form-group <?php echo e($errors->has('zip') ? 'has-error' : ''); ?>">
            <?php echo Form::text('zip', $user->admin->zip, ['id' => 'zip', 'class' => 'form-control', 'placeholder' => get_string('zip')]); ?>
    ...
    <div class="col s12">
        ...
        <?php if($errors->has('avatar')): ?>
            <span class="wrong-error">* <?php echo e($errors->first('avatar')); ?></span>
        <?php endif; ?>
    </div>
