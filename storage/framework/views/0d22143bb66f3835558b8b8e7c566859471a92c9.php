...
<div class="col s12">
    ...
    <?php endif; ?>
    <?php echo Form::open(['method' => 'patch', 'url' => route('owner.property.update', $property->id), 'files' => 'true']); ?>
            ...
            <div class="tab-content">
                <div id="content-panel" class="tab-pane active">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="tab-content"> <div class="col s12">
                                            <div class="form-group">
                                                <?php echo e(Form::text('ref_no', $property->content($language->id)->ref_no, ['class' => 'form-control', 'placeholder' => 'Introducer Code', 'readonly'])); ?>

                                                <?php echo e(Form::label('ref_no', 'Introducer Code')); ?>
                                    ...
                                    <div id="lang<?php echo e($language->id); ?>" class="tab-pane <?php echo e($language->default ? 'active' : ''); ?>">
                                        <div class="col s12">
                                            <div class="form-group  <?php echo e($errors->has('name.'.$language->id.'') ? 'has-error' : ''); ?>">
                                                <?php echo e(Form::text('name',  $property->content($language->id)->name, ['class' => 'form-control', 'placeholder' => get_string('Property_name')])); ?>
                                        ...
                                        <div class="col s12">
                                            <?php echo e(Form::textarea('description', $property->content($language->id)->description, ['class' => 'hidden desc-content'])); ?>
                        ...
                        <div class="row mbot0">
                            <div class="col l6 m12 s12">
                                <div class="row mbot0">
                                    ...
                                    <div class="col l12 m12 s12">
                                        <div class="form-group">
                                            <?php echo e(Form::text('location[geo_lon]', $property->location['geo_lon'], ['class' => 'form-control', 'placeholder' => get_string('geo_lon'), 'readonly'])); ?>
                                    ...
                                    <div class="col l12 m12 s12">
                                        <div class="form-group">
                                            <?php echo e(Form::text('location[geo_lat]', $property->location['geo_lat'], ['class' => 'form-control', 'placeholder' => get_string('geo_lat'), 'readonly'])); ?>
                    ...
                    callback: function (result) {
                        if(result){
                            $.ajax({
                                ...
                                success:function(msg) {
                                    window.location = "/owner/property";
                                }
                            });
                        }
                    }
