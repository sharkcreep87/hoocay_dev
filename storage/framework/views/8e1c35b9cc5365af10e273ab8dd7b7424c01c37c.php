...
<div class="col s12">
    <?php if(!$errors->isEmpty()): ?>
        <span class="wrong-error"><?php echo e($errors->first()); ?></span>
    <?php endif; ?>
     
    <?php echo Form::open(['method' => 'post', 'url' => route('owner.property.store'), 'files' => 'true']); ?>
                            ...
                            <div class="tab-content">
                             <div class="col s12">
                                            <div class="form-group">
                                                <?php echo e(Form::text('ref_no', null, ['class' => 'form-control', 'placeholder' => 'Introducer Code (Optional)'])); ?>

                                                <?php echo e(Form::label('ref_no', 'Introducer Code (Optional)')); ?>
                                    ...
                                    <div id="lang<?php echo e($language->id); ?>" class="tab-pane <?php echo e($language->default ? 'active' : ''); ?>">
                                        <div class="col s12">
                                            <div class="form-group  <?php echo e($errors->has('name.'.$language->id.'') ? 'has-error' : ''); ?>">
                                                <?php echo e(Form::text('name', null, ['class' => 'form-control', 'placeholder' => get_string('enter_property_name')])); ?>

                                                <?php echo e(Form::label('name', get_string('property_name'))); ?>
                                        ...
                                        <div class="col s12">
                                        <span class="wrong-error">* Minimum 100 words</span>
                                            <?php echo e(Form::textarea('description', null, ['class' => 'hidden desc-content form-control','id'=> 'desc'])); ?>

                                            <?php if($errors->has('description')): ?>
                                                <span class="wrong-error">* <?php echo e($errors->first('description')); ?></span>
                    ...
                    <div class="col s12 clearfix">
                        <h5 class="section-title"><?php echo e(get_string('media')); ?></h5>
                          <?php if($errors->has('images')): ?>
                                <span class="wrong-error">* <?php echo e($errors->first('images')); ?></span>
                            <?php endif; ?>
                    </div>
                        ...
                        <div class="row mbot0">
                            <div class="col l6 m12 s12">
                                <div class="row mbot0">
                                    ...
                                    <div class="col l12 m12 s12">
                                        <div class="form-group">
                                            <?php echo e(Form::text('location[geo_lon]', null, ['class' => 'form-control', 'placeholder' => get_string('geo_lon'), 'readonly'])); ?>
                                    ...
                                    <div class="col l12 m12 s12">
                                        <div class="form-group">
                                            <?php echo e(Form::text('location[geo_lat]', null, ['class' => 'form-control', 'placeholder' => get_string('geo_lat'), 'readonly'])); ?>
        ...
        $(document).ready(function(){
            ...
            $('#file-dropzone').dropzone({
                ...
                init: function() {
                  ...
                  /*   alert(<?php echo e(Session::get('image')); ?>); 
                                    
                  <?php if(Session::has('image')): ?>
               

                alert(Session::get('image') );

                        <?php $__currentLoopData = Session::get('image'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $images): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            var mockFile = { name: '<?php echo e($images); ?>', size: 100000 };
                            this.emit("addedfile", mockFile);
                            this.createThumbnailFromUrl(mockFile, '/images/data/<?php echo e($images); ?>');
                            this.emit("success", mockFile);
                        $('.hidden-fields').append('<input type="hidden" name="images[]" value="<?php echo e($images); ?>">');
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                    <?php endif; ?>*/
