...
<?php $__env->startSection('title'); ?>
    <title><?php echo e(get_string('users') . ' - ' . get_setting('site_name', 'site')); ?></title>
...
<div class="col l6 m8 s12 left left-align mbot10">
    <?php echo Form::open(['method' => 'post', 'url' => route('admin_user_search')]); ?>

    <div class="form-group col s8 autocomplete-fix">
        <?php echo e(Form::text('term', null, ['class' => 'form-control', 'id' => 'term', 'placeholder' => get_string('search_users')])); ?>
            ...
            <table class="table bordered striped">
                ...
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <tr>
                        ...
                        <td><?php if($user->user): ?><?php echo e($user->user->first_name); ?> <?php else: ?> - <?php endif; ?></td>
                        <td><?php if($user->user): ?><?php echo e($user->user->last_name); ?> <?php else: ?> - <?php endif; ?></td>
...
<script>
    $(document).ready(function(){
        ...
        $('.delete-button').click(function(event){
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    if(result){
                        $.ajax({
                            url: '<?php echo e(url('/admin/user/destroy')); ?>/'+id,
                            type: 'post',
                            data: {_token :token},
        ...
        $('.upgrade-button').click(function(event){
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    if(result){
                        $.ajax({
                            url: '<?php echo e(url('/admin/user/upgrade')); ?>/'+id,
                            type: 'post',
                            data: {_token :token},
                            success:function(msg) {
                                selector.remove();
        ...
        $('.mass-delete').click(function(event){
            ...
            $('#term').autocomplete({
                source: '<?php echo e(url('/admin/user/autocomplete')); ?>',
                minLength: 0,
                delay: 0,
