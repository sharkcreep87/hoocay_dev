...
<div class="col l6 m6 s12 pull-right">
    ...
    <?php echo Form::open(['method' => 'post', 'url' => route('owner_property_update_dates')]); ?>

    <?php echo e(Form::hidden('dates', null, ['id' => 'dates-input'])); ?>

    <?php echo e(Form::hidden('property_id', $property->id)); ?>

    <button class="btn waves-effect" type="submit" name="action">Update Unavailable Dates</button>
    <?php echo Form::close(); ?>
