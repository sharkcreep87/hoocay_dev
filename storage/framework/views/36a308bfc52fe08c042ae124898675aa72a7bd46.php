                            ...
                            <tr>
                                <td style="<?php echo e($style['email-body_cell']); ?>">
                                    ...
                                    <h1 style="<?php echo e($style['header-1']); ?>">
                                        <?php echo e($mail_data['activate_account']); ?>

                                    </h1>

                                    <!-- Intro -->
                                    <p style="<?php echo e($style['paragraph']); ?>">
                                        <?php echo e($mail_data['message']); ?>
                                    ...
                                    <table style="<?php echo e($style['body_action']); ?>" align="center" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center">
                                                <a href="<?php echo e($mail_data['link']); ?>"
                                                   style="<?php echo e($style['button']); ?> button--blue"
                                                   class="button"
                                                   target="_blank">
                                                    <?php echo e($mail_data['activate_account']); ?>
                                        ...
                                        <tr>
                                            <td style="">
                                                <p style="<?php echo e($style['paragraph-sub']); ?>">
                                                    <?php echo e($mail_data['mail_after_text']); ?>

                                                </p>

                                                <p style="<?php echo e($style['paragraph-sub']); ?>">
                                                    <a style="<?php echo e($style['anchor']); ?>" href="<?php echo e($mail_data['link']); ?>" target="_blank">
                                                        <?php echo e($mail_data['link']); ?>
