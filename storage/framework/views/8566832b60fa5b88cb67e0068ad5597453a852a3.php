                ...
                <div id="header-left" class="col l10 m12 s12 header-col">
                    ...
                    <div id="navigation">
                        <ul class="hide-on-med-and-down clearfix">
                            ...
                            <li class="<?php echo e(setActive('admin/user')); ?>">
                             ...
                             <li class ="<?php echo e(setActive('admin/owner/refund')); ?> "><a href="<?php echo e(route('admin_user_refund')); ?>">Refund</a></li>
                             <li class ="<?php echo e(setActive('admin/owner/transaction')); ?>"><a href="<?php echo e(route('admin_transaction')); ?>">Transaction</a></li>
                    ...
                    <div class="col s6 show-on-small">
                        <ul id="slide-out" class="side-nav">
                            ...
                            <li class="<?php echo e(setActive('admin/booksi')); ?>"><a href="<?php echo e(route('admin_booksi')); ?>">Booksi</a></li>
...
<script src="<?php echo e(URL::asset('assets/js/bootstrap-notify.min.js')); ?>"></script>
