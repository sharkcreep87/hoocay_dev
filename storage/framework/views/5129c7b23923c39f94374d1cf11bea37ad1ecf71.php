                            ...
                            <tr>
                                <td style="<?php echo e($style['email-body_cell']); ?>">
                                    ...
                                    <h1 style="<?php echo e($style['header-1']); ?>">
                                        Well done, your property <?php echo e($mail_data['properties_name']); ?> approved. Please log in to your dashboard from time to time so you don't missed out new booking from guest.
                                    </h1>

                                     <p style="<?php echo e($style['paragraph']); ?>">
                                       Do not forget to update your availablity calender. Click  <a style="<?php echo e($style['anchor']); ?>" href="<?php echo e(url('/owner/property/updateDates/')); ?>" target="_blank">Here</a>. for availablity calender.
