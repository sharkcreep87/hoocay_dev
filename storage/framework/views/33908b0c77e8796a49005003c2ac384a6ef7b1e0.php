...
<?php $__env->startSection('content'); ?>
    <div class="row  marginalized justify-content-center">
        <div class="col-sm-12">
            <h1 class="section-title-dark"><?php echo e($static_data['strings']['register']); ?></h1>
        </div>
               ...
               <!-- <?php if(get_setting('register_owner_directly', 'owner')): ?>
                <div class="col-md-6 col-sm-12">
                    <div class="form-group  <?php echo e($errors->has('register_owner') ? 'has-error' : ''); ?>">
                        ...
                        <?php endif; ?>-->
                        <?php echo e(Form::hidden('register_owner', 0)); ?>
                ...
                <?php endif; ?>
                  <div class="col-md-6 col-sm-12">
                        ...
                        <input type="checkbox" name="terms" required/> &nbsp;&nbsp;&nbsp;I have agree with Term and Condition from hoocay.
                        </div>
