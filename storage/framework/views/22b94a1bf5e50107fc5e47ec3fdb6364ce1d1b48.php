...
<?php $__env->startSection('content'); ?>
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <?php $__currentLoopData = $property->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <div class="carousel-item  <?php if(!$c): ?> active <?php $c++; ?> <?php endif; ?> ">
                            ...
                            <img class="" src="<?php echo e(URL::asset('images/data').'/'.$image->image); ?>" />
                        </div>
                        </div>
        ...
        <div class="col-md-4 col-sm-12 sidebar">
            ...
            <div class="booking-form input-style filter-box mbot20">
                ...
                <p class="field-info text-centered mbot5"><?php echo e($static_data['strings']['fill_fields_to_book']); ?></p>
                        ...
                        <input type="hidden" value="<?php if($static_data['user']): ?><?php echo e($static_data['user']->info->first_name); ?><?php endif; ?>" name="first_name" required class="form-control filter-hidden hidden" placeholder="<?php echo e($static_data['strings']['your_name']); ?>">
                
           
                
                        <input type="hidden" value="<?php if($static_data['user']): ?><?php echo e($static_data['user']->email); ?><?php endif; ?>" name="email" class="form-control filter-hidden hidden" required placeholder="<?php echo e($static_data['strings']['your_email']); ?>">
             
                    
                        <input type="hidden" value="<?php if($static_data['user']): ?><?php echo e($static_data['user']->info->phone); ?><?php endif; ?>" required name="phone" class="form-control filter-hidden hidden" placeholder="<?php echo e($static_data['strings']['your_phone']); ?>">

                            <input type="hidden" value="1" required name="isbook" class="form-control filter-hidden hidden">
                    ...
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <?php if(isset($property->price_per_night)): ?><tr><td><?php echo e($static_data['strings']['price_per_night']); ?> </td><td class="price-per-night"><strong><?php echo e($property->price_per_night); ?></strong></td></tr><?php endif; ?>
                                <?php if(isset($property->fees['cleaning_fee'])): ?><tr><td><?php echo e($static_data['strings']['cleaning_fee']); ?> </td><td class="cleaning-fee"><strong><?php echo e('RM' .$property->fees['cleaning_fee']); ?></strong></td></tr><?php endif; ?>
                                <?php if(isset($property->fees['city_fee'])): ?><tr><td><?php echo e($static_data['strings']['city_fee']); ?> </td><td class="city-fee"><strong><?php echo e('RM' .$property->fees['city_fee']); ?></strong></td></tr><?php endif; ?>
                                 <tr> <td>Service charge</td><td><strong><?php echo e($commission); ?> %</strong></td></tr>
                                <tr><td>Total </td>
                                <td class="total-book"><strong></strong></td></tr>
            ...
            <?php else: ?>
                <p class="field-info text-centered mbot5"><?php echo e($static_data['strings']['login_to_book']); ?>

                 <a href="<?php echo e(route('login')); ?>" class="btn btn btn-info"><?php echo e($static_data['strings']['sign_in']); ?></a>
                </p>
                 <?php endif; ?>
             <?php else: ?> 
  ...
  Host cannot book properties, Please register as guest to book.
</div>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
           ...
           // var array = $dates;
          // var array3 = JSON.parse(<?php echo json_encode($dates); ?>);
            var array2 = ['05/13/2019','05/14/2019','05/15/2019','05/16/2019','05/22/2019'];
           // alert(array);
            console.log(array);
            console.log(array2);
            // Datepickers
                    ...
                    $('.end_date-picker').datepicker({
                        ...
                        onSelect: function(dateText, inst) {
                            ...
                            if(condition){
                                ...
                                var days = dates.length, price = 0, total = 0, total_book = 0,commission=0;
                                ...
                                total1 = total_book <?php if(isset($mainProperty->fees['city_fee'])): ?> + <?php echo e(currency($mainProperty->fees['city_fee'], $static_data['site_settings']['currency_code'], Session::get('currency'), false)); ?> <?php endif; ?> <?php if(isset($mainProperty->fees['cleaning_fee'])): ?> + <?php echo e(currency($mainProperty->fees['cleaning_fee'], $static_data['site_settings']['currency_code'], Session::get('currency'), false)); ?> <?php endif; ?>;
                                 total = total1 + total1 * <?php echo e($commission); ?>/100;

                                 commission = total1 * <?php echo e($commission); ?>/100;

                          
                               
                                // commission = total1 * <?php echo e($commission); ?>)/100;
                                $('.booking-total').show();$('.total-nights strong').html(days);$('.price-per-night strong').html("RM").append(price);$('.total-book strong').html("RM").append(total.toFixed(2));$('.total-field').val(total.toFixed(2));
                            }else{
                                $('.booking-data').show();
