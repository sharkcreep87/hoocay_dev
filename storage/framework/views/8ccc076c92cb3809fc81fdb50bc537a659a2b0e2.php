...
<?php $__env->startSection('content'); ?>
    <div class="row  marginalized justify-content-center">
        <div class="col-sm-12">
            ...
            <?php endif; ?>
             <?php if($isbook == 1): ?>
                <p class="section-subtitle-light text-centered red-color"><strong>To book this property you must login/register first.</strong></p>
            <?php endif; ?>
        ...
        <div class="col-sm-12 col-md-8 input-style user-action-form">
            ...
            <div class="col-sm-12 text-centered">OR</div>
                  <hr>    <div class="col-sm-12 text-centered mtop20">
                  Don't have account yet? <br>
                
                  <a class="btn btn-primary" href="<?php echo e(route('register')); ?>" role="button">Register</a>
