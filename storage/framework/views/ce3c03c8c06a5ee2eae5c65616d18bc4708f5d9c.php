            ...
            <table class="table bordered striped">
                ...
                <?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <tr>
                        ...
                        <td><?php if($property->contentDefault): ?><?php echo e($property->contentDefault->name); ?> <?php else: ?> - <?php endif; ?></td>
                             <td><?php if($property->contentDefault): ?><?php echo e($property->contentDefault->ref_no); ?> <?php else: ?> - <?php endif; ?></td>
