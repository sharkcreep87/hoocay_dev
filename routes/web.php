...
Route::group(['middleware' => 'admin'], function(){
    ...
    Route::get('/admin/logout', 'Admin\AdminLoginController@logout')->name('admin_logout');
     Route::get('/admin/dashboard/withdrwal_notify','Admin\AdminLoginController@withdrawal');
    Route::get('/admin/dashboard','Admin\AdminLoginController@dashboard')->name('admin_dashboard');
    Route::get('/admin/booksi','Admin\AdminLoginController@booksi')->name('admin_booksi');
    ...
    Route::get('/admin/owner/withdrawal', 'Admin\AdminWithdrawalController@index')->name('admin_user_withdrawals');
     ...
     Route::get('/admin/owner/withdrawal/{id}', 'Admin\AdminWithdrawalController@index_state')->name('admin_owner_withdrawals_state');
    Route::get('/admin/generatePDF/{id}', 'Admin\AdminWithdrawalController@generate_pdf')->name('admin_generatePDF');

    Route::get('/admin/generateRefundPDF/{id}', 'Admin\AdminWithdrawalController@generate_refund_pdf')->name('admin_generate_refund_PDF');
    //refund
    Route::get('/admin/owner/refund', 'Admin\AdminWithdrawalController@refund')->name('admin_user_refund');
    ...
    Route::post('/admin/owner/refund/delete/{id}', 'Admin\AdminWithdrawalController@deleteRefund');
    Route::post('/admin/owner/withdrawal/details/{id}', 'Admin\AdminWithdrawalController@userInfo');
    Route::post('/admin/owner/refund/details/{id}', 'Admin\AdminWithdrawalController@userPaymentInfo');
    Route::get('/admin/transaction/', 'Admin\AdminWithdrawalController@transaction')->name('admin_transaction');
Route::post('/admin/refund/completed/{id}', 'Admin\AdminWithdrawalController@completeRefund');
...
Route::group(['middleware' => 'user'], function(){
    ...
    Route::get('/user-profile', 'UserController@profile')->name('user_dashboard');
    Route::post('/user-update', 'UserController@update')->name('user_update');
    Route::post('/user-request', 'UserController@request');
    Route::post('/user-upload', 'UserController@savePhoto')->name('photo_upload');
    Route::post('/user/booking/cancel/{id}', 'UserController@BookingCancel');
...
//shafeq
Route::get('/booking/payment/success_billplz', 'PaymentController@paymentSuccessBillplz')->name('book_payment_success_billplz');
...
Route::post('/user/booking/details/{id}', 'UserController@bookingInfo');
Route::get('/user/booking/details/{id}', 'UserController@bookingInfo');
Route::post('/user/refund/confirm', 'UserController@ConfirmRefund');
...
//shafeq
Route::get('/owner-register', 'UserController@register_owner')->name('register_owner')->middleware('logged');
//Route::post('/owner-register', 'RegisterController@register_owner')->name('register_owner')->middleware('logged');
...
Route::group(['middleware' => 'owner'], function(){
    ...
    Route::group(['middleware' => 'owner_active'], function(){
        ...
        Route::post('/owner/withdrawal/request', 'Owner\OwnerWithdrawalController@request')->name('request_withdrawal');
         ...
         Route::post('/owner/withdrawal/update', 'Owner\OwnerWithdrawalController@updatePayment')->name('update_payment');
        ...
        Route::get('/owner/points/payment/cancel', 'Owner\OwnerPointController@paymentCancel')->name('payment_point_cancel');
          ...
          //transaction
     Route::get('/admin/owner/transaction', 'Owner\OwnerWithdrawalController@transaction')->name('owner_transaction');
