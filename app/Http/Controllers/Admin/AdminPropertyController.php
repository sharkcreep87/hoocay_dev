...
class AdminPropertyController extends Controller
{
        ...
        if($request->ajax()) {
            ...
            $property->save();
              ...
              $user = User::findOrFail($property->user_id);
                ...
                $mail_data['subject'] = "Properties on hoocay approval";
                ...
                $mail_data['properties_name'] = $property->alias;



                 Mail::send('emails.property_activate', ['mail_data' => $mail_data], function ($m) use ($mail_data) {
    ...
    public function updateDates(Request $request){
        ...
        $count = $property_dates->update($data);
