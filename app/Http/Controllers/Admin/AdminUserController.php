...
class AdminUserController extends Controller
{
    ...
    public function destroy(Request $request, $id){
        if($request->ajax()){
            if(Property::where('user_id', $id)->first() || Service::where('user_id', $id)->first() || Review::where('user_id', $id)->first() || Booking::where('user_id', $id)->first()){
    ...
    public function delete($id){
     ...
     //   Social::where('user_id', $user->id)->first()->delete();
