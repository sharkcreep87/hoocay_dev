...
class OwnerBookingController extends Controller
{
    ...
    public function index(){
        ...
        $bookings = Booking::where('owner_id', $user->id)->orderBy('created_at', 'desc')->paginate(10);
        return view('owner.booking', compact('bookings', 'currency'));
    }
    ...
    public function reject(Request $request, $id){
        if($request->ajax()) {
            ...
            $owner->pending_balance -= $booking->total * 10 / 100;
            $owner->save();
               ...
               $random= rand(000000,999999);
                        ...
                        $refund->description = 'Owner canceled booking';
