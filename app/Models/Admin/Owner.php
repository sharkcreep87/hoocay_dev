...
class Owner extends Model
{
    ...
    protected $fillable = [
        'user_id', 'active_balance', 'pending_balance', 'first_name', 'phone', 'last_name', 'address', 'city', 'state', 'zip', 'country', 'logo', 'points' ,'bank','acct_name', 'acct_no','paypal_acct','payment_method'
    ];
