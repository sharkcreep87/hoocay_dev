...
class ActivationFactory
{
    ...
    public function sendUserRegisteredToAdmin ($user)
    {
        ...
        // Create the mail and send it
        Mail::send('emails.registerNotification', ['mail_data' => $mail_data], function ($m) use ($mail_data) {
            $m->from($mail_data['admin_email'], $mail_data['site_name']);
            $m->to("admin@hoocay.com")->subject("New User has created an account");
        });
