                            ...
                            <tr>
                                <td style="{{ $style['email-body_cell'] }}">
                                    ...
                                    <p style="{{ $style['paragraph'] }}">
                                        <strong>Your pending balance RM {{$mail_data['amount']}} now have been credited into your available balance. You can withdraw your money from this available balance.</strong><br/>
                                    ...
                                    <!-- Salutation -->
                                    <p style="{{ $style['paragraph'] }}">
                                        Regards,<br>{{ $mail_data['site_name'] }}
                                    </p>
                                        ...
                                        <tr>
                                            <td style="">
                                                <p style="{{ $style['paragraph-sub'] }}">
                                                    Please login and go into dashboard to see your available balance.
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
