                            ...
                            <tr>
                                <td style="{{ $style['email-body_cell'] }}">
                                    ...
                                    <h1 style="{{ $style['header-1'] }}">
                                        Well done, your property {{ $mail_data['properties_name'] }} approved. Please log in to your dashboard from time to time so you don't missed out new booking from guest.
                                    </h1>

                                     <p style="{{ $style['paragraph'] }}">
                                       Do not forget to update your availablity calender. Click  <a style="{{ $style['anchor'] }}" href="{{ url('/owner/property/updateDates/') }}" target="_blank">Here</a>. for availablity calender.
