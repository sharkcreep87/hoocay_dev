                            ...
                            <tr>
                                <td style="{{ $style['email-body_cell'] }}">
                                    ...
                                    <h1 style="{{ $style['header-1'] }}">
                                        Well done, your property {{ $mail_data['properties_name'] }} approved. Please log in to your dashboard from time to time so you don't missed out new booking from guest. Thank you.
                                    </h1>
