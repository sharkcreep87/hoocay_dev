...
@section('content')
    ...
    <div class="row  marginalized">
        <div class="col-sm-12">
            <h1 class="section-title-dark">{{$static_data['strings']['update_profile']}}</h1>
        </div>
        ...
        <div class="col-xs-6 col-xs-offset-3">
            <div class="checkbox">
                ...
                <div class="modal-footer">
                    ...
                    <a href="#" data-id="{{ $static_data['user']->id }}" class="primary-button confirm-request" data-dismiss="modal">Agree</a>
                </div>
