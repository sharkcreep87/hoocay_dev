                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <ul class="top-menu">
                            ...
                            @if($static_data['user'] && $static_data['user']->role->id == 3)<li class="{{ setActive('my-account') }}"><a href="https://hoocay.com/user-profile"><i class="fa fa-user"></i> {{$static_data['strings']['my_account']}}</a></li>
                           @endif
                    ...
                    <div class="col-md-12 col-lg-9">
                        ...
                        <!-- <li><a href="#">{{$static_data['strings']['owners']}}</a></li> -->
                            ...
                            @if(!$static_data['user'])<li class="{{ setActive('login') }}"><a href="{{ route('login') }}" class="white-button">{{ $static_data['strings']['sign_in'] }}</a></li>@endif
                             @if(!$static_data['user'])<li class="{{ setActive('register') }}"><a href="{{ route('register') }}" class="white-button">Register As Guest</a></li>@endif
                            @if(!$static_data['user'])<li class="{{ setActive('register_owner') }}"><a href="{{ route('register_owner') }}" class="white-button">Become a Host</a></li>@endif
                             @if($static_data['user'] && $static_data['user']->role->id == 2)<li class="{{ setActive('owner/property/create') }}"><a href="{{ route('owner.property.create') }}" class="white-button">{{ $static_data['strings']['add_your_property'] }}</a></li>@endif
            ...
            <div class="mobile-menu">
                ...
                <!-- <li><a href="#">{{$static_data['strings']['owners']}}</a></li> -->
                    ...
                    <!--<li class="{{ setActive('contact') }}"><a href="{{route('contact')}}"><i class="fa fa-envelope"></i> {{$static_data['strings']['contact']}}</a></li>-->
                     @if(!$static_data['user'])<li class="{{ setActive('register') }}"><a href="{{ route('register') }}"> <i class="fa fa-user"></i>  Register As Guest</a></li>@endif
                    ...
                    @if(!$static_data['user'])<li class="{{ setActive('register_owner') }}"><a href="{{ route('register_owner') }}"> <i class="fa fa-user"></i> Become a Host</a></li>@endif
                   @if($static_data['user'])<li class="{{ setActive('owner/property/create') }}"><a href="{{ route('owner.property.create') }}" class="white-button">{{ $static_data['strings']['add_your_property'] }}</a></li>@endif
                    @if($static_data['user'] && $static_data['user']->role->id == 3 && $owner_request)<li><a class="white-button request-upgrade" data-toggle="modal" data-target="#upgrade-confirm-modal" >{{ $static_data['strings']['add_your_property'] }}</a></li>@endif
                </ul>
            </div>
        </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <!--  <div class="form-group">
                                        ...
                                        <ul class="dropdown-slider-menu">
                                          ...
                                          @for($i = 1; $i <= 30; $i++)
                                                <li data-id="{{ $i }}" data-name="{{ $i }}">
                                                    <a href="#">
                                                        <i class="fa fa-users"></i>
                                                        <span>{{$i}}</span>
                                                          <input type="hidden" name="guest" value='{{$i}}' class="form-control slider-hidden hidden" placeholder="How many guess?">
                                                    </a>
                                                </li>
                                            @endfor
            ...
            <div class="col-md-3 col-sm-12 footer-widgets">
                ...
                <ul class="footer-menu">
                   <!-- <li><a href="{{$static_data['design_settings']['footer_menu2_link1']}}">{{$static_data['strings']['opt_footer_menu2_text1']}}</a></li>-->
                    ...
                    <li><a href="{{$static_data['design_settings']['footer_menu2_link5']}}">News</a></li>
                </ul>
            </div>
