...
<script>
  ...
  fbq('init', '769223046777234');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=769223046777234&ev=PageView&noscript=1"
/></noscript>
                        ...
                        <!-- <li><a href="#">{{$static_data['strings']['owners']}}</a></li> -->
                           ...
                           <!-- <li class="{{ setActive('contact') }}"><a href="{{route('contact')}}">{{$static_data['strings']['contact']}}</a></li>-->
                            @if(!$static_data['user'])<li class="{{ setActive('login') }}"><a href="{{ route('login') }}" class="white-button">{{ $static_data['strings']['sign_in'] }}</a></li>@endif
                             @if(!$static_data['user'])<li class="{{ setActive('login') }}"><a href="{{ route('register_owner') }}"> <i class="fa fa-user"></i> Become a Host</a></li>@endif
