                        ...
                        <div class="card">
                            <div class="card-content no-padding">
                                <div class="blue-card card-stats-body waves-effect">
                                    ...
                                    <div class="stats-text left-align">
                                        <strong class="counter">{{ number_format($data['pending_balance'], 2, '.', ',')  }}</strong> {{ $currency  }}<br>
                        ...
                        <div class="card">
                            <div class="card-content no-padding">
                                <div class="blue-card card-stats-body waves-effect">
                                    ...
                                    <div class="stats-text left-align">
                                        <strong class="counter"> {{ number_format($data['active_balance'] , 2, '.', ',') }}</strong> {{ $currency  }}<br>
                        ...
                        <div class="card">
                            <div class="card-content no-padding">
                                <div class="blue-card card-stats-body waves-effect">
                                    ...
                                    <div class="stats-text left-align">
                                        <strong class="counter">{{ number_format($withdraw, 2, '.', ',')  }}</strong> {{ $currency  }}<br>
