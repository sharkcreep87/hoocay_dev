...
<div class="col s12">
    ...
    @endif
    {!!Form::open(['method' => 'patch', 'url' => route('owner.property.update', $property->id), 'files' => 'true'])!!}
    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="tab-content"> <div class="col s12">
                                            <div class="form-group">
                                                {{Form::text('ref_no', $property->content($language->id)->ref_no, ['class' => 'form-control', 'placeholder' => 'Introducer Code', 'readonly'])}}
                                                {{Form::label('ref_no', 'Introducer Code')}}
                                    ...
                                    <div id="lang{{$language->id}}" class="tab-pane {{$language->default ? 'active' : ''}}">
                                        <div class="col s12">
                                            <div class="form-group  {{$errors->has('name.'.$language->id.'') ? 'has-error' : ''}}">
                                                {{Form::text('name',  $property->content($language->id)->name, ['class' => 'form-control', 'placeholder' => get_string('Property_name')])}}
                                                {{Form::label('name', get_string('property_name'))}}
                                                @if($errors->has('name'))
                                        ...
                                        <div class="col s12">
                                            {{Form::textarea('description', $property->content($language->id)->description, ['class' => 'hidden desc-content'])}}
                                            @if($errors->has('description'))
                                                <span class="wrong-error">* {{$errors->first('description')}}</span>
                                            @endif
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <div class="row mbot0">
                            <div class="col l6 m12 s12">
                                <div class="row mbot0">
                                    ...
                                    <div class="col l12 m12 s12">
                                        <div class="form-group">
                                            {{Form::text('location[geo_lon]', $property->location['geo_lon'], ['class' => 'form-control', 'placeholder' => get_string('geo_lon'), 'readonly'])}}
                                            {{Form::label('location[geo_lon]', get_string('geo_lon'))}}
                                        </div>
                                    </div>
                                    <div class="col l12 m12 s12">
                                        <div class="form-group">
                                            {{Form::text('location[geo_lat]', $property->location['geo_lat'], ['class' => 'form-control', 'placeholder' => get_string('geo_lat'), 'readonly'])}}
