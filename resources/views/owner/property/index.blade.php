...
<div class="alert alert-warning">
  <strong>Success!</strong> {{ get_string('waiting_approval') }}
</div>
...
<div class="col l6 m8 s12 left left-align mbot10">
    {{Form::open(['method' => 'post', 'url' => route('owner_property_search')])}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="icon-options">
                                ...
                                <a href="{{route('owner_property_date', $property->id)}}" title="{{get_string('property_availability')}}"><i class="small material-icons color-blue">date_range</i></a>
...
@section('footer')
    <script>
        $(document).ready(function(){
            ...
            $('#term').autocomplete({
                source: '{{ url('/owner/property/autocomplete') }}',
                minLength: 0,
                delay: 0,
