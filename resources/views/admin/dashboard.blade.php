            ...
            <div class="row mbot0">
                <div class="col s12">
                    ...
                    <div class="col l3 m6 s12">
                     ...
                     <div class="col l3 m6 s12">
                         <a href= "{{ url('/admin/owner/withdrawal') }}" >
                        <div class="card">
                            <div class="card-content no-padding">
                                <div class="blue-card card-stats-body waves-effect">
                                    <div class="stats-icon right-align">
                                    ...
                                    <div class="stats-text left-align">
                                        <strong class="counter">{{ $data['withdraw_req'] }}</strong><br>
                     ...
                     <div class="col l3 m6 s12">
                        <a href= "{{ url('/admin/owner/payment') }}" >
                        <div class="card">
                            <div class="card-content no-padding">
                                <div class="blue-card card-stats-body waves-effect">
                                    <div class="stats-icon right-align">
                                    ...
                                    <div class="stats-text left-align">RM
                                        <strong class="counter">{{ number_format($data['payment_all'] , 2, '.', ',') }}</strong><br>
                        ...
                        <div class="card">
                            <div class="card-content no-padding">
                                <div class="blue-card card-stats-body waves-effect">
                                    ...
                                    <div class="stats-text left-align">RM
                                        <strong class="counter">{{ number_format($data['paid'] , 2, '.', ',') }}</strong><br>
                        ...
                        <div class="card">
                            <div class="card-content no-padding">
                                <div class="blue-card card-stats-body waves-effect">
                                    ...
                                    <div class="stats-text left-align">
                                        <strong class="counter">{{ number_format($data['profit']  , 2, '.', ',')}}</strong><br>
                                        <span>Profit</span>
                                    </div>
                                </div>
                            </div><!--end .card-body -->
    ...
    <script>
        $(document).ready(function($) {
            $('.counter').counterUp({
             ...
             $.ajax({
                                    url: '{{ url('/admin/dashboard/withdrwal_notify') }}',
                                    type: 'get',
